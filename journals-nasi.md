...
## What I built
- Illustrator drawings for panels and the slot.
- LED post placement and cable path mapping.
- Exported cut dimensions.

## Decisions
- Narrow slot for better sensor coverage.
- Centered disco ball visually.

## Issues and fixes
- Adjusted panel width for wood thickness.
...
## What I built
- Measured cuts and helped assemble the base.
- Verified squareness.
- Added corner blocks for strength.

## Decisions
- Extra support near the motor mount.
- Pilot holes to protect the wood.

## Issues and fixes
- Beam twist fixed by rotating piece.
...
## What I built
- Installed shelves and front rails.
- Positioned a slot.
- Checked crate and electronics spacing.

## Decisions
- Clean front layout for better visuals.
- Space for spare cables under crate.

## Issues and fixes
- Shelf clashing with chute trimmed and reseated.
...
## What I built
- Set up ESP32 with addressable LEDs.
- Wrote animation patterns.
- Added serial listener for show triggers.
- Tuned brightness and colors.

## Decisions
- Lower brightness for indoor use.

## Issues and fixes
- Flicker from bad connector fixed by recrimping.
...
## What I built
- Built and mounted four LED posts.
- Routed cables through holes.
- Checked reflections on the ball.

## Decisions
- Posts placed near corners.
- Cable exits hidden along inner rim.

## Issues and fixes
- Leaning post braced with small support.
...
## What I built
- Sanded and rolled second blue coat.
- Painted top black.
- Cleaned paint lines.

## Decisions
- Blue exterior and black top.

## Issues and fixes
- Uneven slot line masked and repainted.

## Picture
![](https://hc-cdn.hel1.your-objectstorage.com/s/v3/f6d1de254c430a2c468d748a3f569492841f74c7_tmp_3Achat_3A2025-11-02_3Acmh69pxsq00cop401dxr6jvx8_3A6bfbcf851e702582)
...
## What I built
- Extended LED cables and added connectors.
- Installed curtain to hide electronics but still can show it.
- Routed and labeled cables.

## Decisions
- Use short jumpers for strip replacements.

## Issues and fixes
- Loose connector replaced with latch type.

## Picture
![](https://hc-cdn.hel1.your-objectstorage.com/s/v3/b11a752ad4ac0066120028c93ec3ca964353376b_tmp_3Achat_3A2025-11-02_3Acmh69pxsq00cop401dxr6jvx8_3A6787a292e1a59fb1)
...
## What I built
- Mounted disco ball and checked spin.
- Synced LED timing with audio and smoke.
- Captured final demo material.

## Decisions
- Six second show duration.
- Idle glow while waiting.

## Issues and fixes
- Motor EMI solved by rerouting data line.
